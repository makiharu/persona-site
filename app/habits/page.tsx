...
export const metadata: Metadata = {
  title: 'Habits - makiharu',
  description: '習慣についての記録',
};
  ...
  return (
    <div className="max-w-[760px] mx-auto px-6 md:px-8 py-16 md:py-20">
      <div className="mb-20 md:mb-24">
        <h1 className="text-2xl md:text-3xl font-normal mb-8 text-gray-900">Habits</h1>
      ...
      <section>
        {posts.length > 0 ? (
          <ul className="space-y-10 md:space-y-12">
            {posts.map((post) => (
              <li key={post.slug}>
                <Link href={`/habits/${post.slug}`} className="group block">
                  <article>
